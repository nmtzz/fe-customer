...
onMounted(() => {
  document.title = t('product.all', 'All Products');
  getExchangeRate();
});
    ...
    <div class="max-w-[1440px] mx-auto px-3 sm:px-4 lg:px-6">
      <div class="flex flex-col md:flex-row gap-6">
        ...
        <div class="flex-grow">
          ...
          <div v-if="filteredProducts.length === 0" class="py-8 text-center bg-gray-50 rounded-lg">
